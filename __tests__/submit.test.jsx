...
test('Fragment: submit(ref) with no errors', async () => {
  ...
  const testRenderer = create(
    <BabyForm Container={Fragment} value={value} ref={ref}>
      <input id="name" type="text" _name="name" _required />
    </BabyForm>
  );
...
test('Fragment: submit(ref) with errors', async () => {
  const value = { name: '' };
  const ref = { current: null };
  const errors = [{
    key: 'name',
...
test('Fragment: submit(ref) with errors and child BabyForm', async () => {
  const value = { baby: { name: '' } };
  const ref = { current: null };
  const errors = [{
    key: 'name',
...
test('Fragment: submit(ref) with errors  and complex data structure', async () => {
  const value = [{ baby: { name: '' } }];
  const ref = { current: null };
  const errors = [{
    key: 'name',
...
test('Fragment: ref.current.submit() with errors', async () => {
  const value = { name: '' };
  const ref = { current: null };
  const errors = [{
    key: 'name',
...
test('Fragment: ref.current.submit() with errors and child BabyForm', async () => {
  const value = { baby: { name: '' } };
  const ref = { current: null };
  const errors = [{
    key: 'name',
...
test('Fragment: ref.current.submit() with errors  and complex data structure', async () => {
  const value = [{ baby: { name: '' } }];
  const ref = { current: null };
  const errors = [{
    key: 'name',
...
test('Fragment(null): submit(ref) with no errors', async () => {
  ...
  const testRenderer = create(
    <BabyForm Container={null} value={value} ref={ref}>
      <input id="name" type="text" _name="name" _required />
    </BabyForm>
  );
...
test('Fragment(null): submit(ref) with errors', async () => {
  const value = { name: '' };
  const ref = { current: null };
  const errors = [{
    key: 'name',
...
test('Fragment(null): submit(ref) with errors and child BabyForm', async () => {
  const value = { baby: { name: '' } };
  const ref = { current: null };
  const errors = [{
    key: 'name',
...
test('Fragment(null): submit(ref) with errors  and complex data structure', async () => {
  const value = [{ baby: { name: '' } }];
  const ref = { current: null };
  const errors = [{
    key: 'name',
...
test('Fragment(null): ref.current.submit() with errors', async () => {
  const value = { name: '' };
  const ref = { current: null };
  const errors = [{
    key: 'name',
...
test('Fragment(null): ref.current.submit() with errors and child BabyForm', async () => {
  const value = { baby: { name: '' } };
  const ref = { current: null };
  const errors = [{
    key: 'name',
...
test('Fragment(null): ref.current.submit() with errors  and complex data structure', async () => {
  const value = [{ baby: { name: '' } }];
  const ref = { current: null };
  const errors = [{
    key: 'name',
