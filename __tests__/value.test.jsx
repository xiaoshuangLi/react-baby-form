...
test('Fragment: set correct value by _name', () => {
  const value = {
    name: 'xiaoshuang',
    age: '28',
  };
...
test('Fragment: set correct value by _name in child BabyForm', () => {
  const value = {
    age: '28',
    baby: {
      name: 'xiaoshuang',
...
test('Fragment: set correct value from complex data structure', () => {
  const value = [
    {
      age: '28',
      baby: {
...
test('Fragment(null): set correct value by _name', () => {
  const value = {
    name: 'xiaoshuang',
    age: '28',
  };
...
test('Fragment(null): set correct value by _name in child BabyForm', () => {
  const value = {
    age: '28',
    baby: {
      name: 'xiaoshuang',
...
test('Fragment(null): set correct value from complex data structure', () => {
  const value = [
    {
      age: '28',
      baby: {
